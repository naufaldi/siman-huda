					...
					while($row = mysqli_fetch_assoc($sql)){
						...
						<tr>
							...
							<td>
								...
								<a href="edit_kamar.php?nama_kamar='.$row['nama_kamar'].'" title="Rubah Data"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
								
								<a href="datakamar.php?aksi=delete&nama_kamar='.$row['nama_kamar'].'" title="Hapus Data" onclick="return confirm(\'Yakin Ingin Menghapus?\')"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
							</td>
						</tr>
						';
						$no++;
